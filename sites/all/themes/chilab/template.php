 ...
 */
function chilab_breadcrumb($variables){
 ...
 */
function chilab_preprocess_block(&$variables) {
 ...
 */
function chilab_preprocess_html(&$variables) {
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/style-' .$color_scheme. '.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/merriweather-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/sourcesanspro-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/ubuntu-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/ptsans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/roboto-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/opensans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/lato-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/roboto-condensed-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/exo-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/roboto-slab-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/raleway-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/josefin-sans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/playfair-display-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/philosopher-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/cinzel-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/oswald-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/playfairdisplaysc-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/cabin-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/notosans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/droidserif-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/ptserif-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/vollkorn-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/alegreya-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }	
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/notoserif-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/crimsontext-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/gentiumbookbasic-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/volkhov-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	...
	// 	drupal_add_css(drupal_get_path('theme', 'chilab') . '/fonts/alegreyasc-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	// }
	 ...
	 */
	drupal_add_css(drupal_get_path('theme', 'chilab') . '/local.css', array('group' => CSS_THEME, 'type' => 'file'));

	/**
	* Bootstrap CDN
	*/
    // if (theme_get_setting('bootstrap_css_cdn', 'chilab')) {
    //     $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_css_cdn', 'chilab')  . '/css/bootstrap.min.css';
    //     drupal_add_css($cdn, array('type' => 'external'));
    // }
    
    // if (theme_get_setting('bootstrap_js_cdn', 'chilab')) {
    //     $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_js_cdn', 'chilab')  . '/js/bootstrap.min.js';
    //     drupal_add_js($cdn, array('type' => 'external'));
    // }

    // if (theme_get_setting('bootstrap_fa_cdn', 'chilab')) {
    //     $cdn = '//maxcdn.bootstrapcdn.com/font-awesome/' . theme_get_setting('bootstrap_fa_cdn', 'chilab')  . '/css/font-awesome.min.css';
    //     drupal_add_css($cdn, array('type' => 'external'));
    // }
	...
	drupal_add_css(drupal_get_path('theme', 'chilab') . '/js/meanmenu/meanmenu.css');
	drupal_add_js(drupal_get_path('theme', 'chilab') .'/js/meanmenu/jquery.meanmenu.fork.js', array('preprocess' => false));
 ...
 * Override or insert variables into the html template.
 */
function chilab_process_html(&$vars) {
 ...
 */
function chilab_preprocess_page(&$variables) {
	
	$three_columns_grid_layout = theme_get_setting('three_columns_grid_layout', 'chilab');
	...
	if (drupal_get_path_alias() == 'publications') {
        ...
        drupal_add_js(drupal_get_path('theme', 'chilab') .'/js/list.min.js', array('preprocess' => false));
...
*/
function chilab_preprocess_maintenance_page(&$variables) {

	$color_scheme = theme_get_setting('color_scheme');
	if ($color_scheme != 'default') {
		drupal_add_css(drupal_get_path('theme', 'chilab') . '/style-' .$color_scheme. '.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
...
function chilab_page_alter($page) {
...
function chilab_form_alter(&$form, &$form_state, $form_id) {
